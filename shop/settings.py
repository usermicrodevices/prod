...
'content':'<p class="page-pad">{%autoescape off%}{{svg}}{%endautoescape%}</p>',
'extinfo':{
'script':'<script>window.onload=function(){document.getElementsByTagName("head")[0].remove();document.body.style.margin=0;document.body.style.padding=0;document.body.style.width=0;document.body.style.height=0;const parea = document.getElementById("section-to-print");while(document.body.firstChild){document.body.removeChild(document.body.firstChild);}document.body.appendChild(parea);setTimeout(function(){window.print();},0);window.onfocus=function(){setTimeout(function(){window.location.reload();},0);}}</script>',
'css_media_style':'@media (orientation:landscape) print{html body{visibility:hidden;height:auto;margin:0;padding:0;} .content{position:absolute;top:0;} .messagelist{margin:0;padding:0;} #section-to-print{text-align:center;background-color:white;width:0;display:flex;flex-direction:column;visibility:visible;position:absolute;left:0;top:0;}} @page{size: 10.0mm 11.0mm ;margin:0;} .page-pad{break-after:page;margin:0;padding:0;} .page-pad:last-of-type{break-after:avoid!important;} html:root{--message-success-bg:unset;} #container{height:max-content;width:max-content;min-width:unset;} ul.messagelist li{display:unset;margin:0;padding:0;background:white;background-size:unset;font-size:unset;word-break:unset;color:black;} header,footer,aside,nav,form,iframe,button,.ad,.success,#header,#content,#toggle-nav-sidebar{display:none;}',
'qr_border':0,
'qr_box_size':10,
'qr_version':1}
}
